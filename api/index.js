...
// Import services
const localStorage = require('../backend/services/localStorage');
const firebaseAuth = require('../backend/services/firebaseAuth');

// Import routes
const authRoutes = require('../backend/routes/auth');
const productRoutes = require('../backend/routes/products');
const paymentRoutes = require('../backend/routes/payments');
const schemesRoutes = require('../backend/routes/schemes');
